export default {
	"Asia": [
    "Burma", "Korea, South", "Macau", "Republic of Korea", "Taipei and environs", "Taiwan", "West Bank and Gaza",
	...
	"Europe": [
    "Czechia", "Channel Islands", "Guernsey", "Jersey", "Kosovo", "Montenegro", "MS Zaandam", "Diamond Princess", "North Ireland", "Republic of Ireland",
    "Republic of Moldova", "Russia", "Serbia", "Vatican City",
    "Albania", "Andorra", "Austria", "Belarus", "Belgium", "Bosnia and Herzegovina", "Bulgaria", "Croatia", "Czech Republic", "Denmark", "England", "Estonia", "Faroe Islands", "Finland", "France", "Germany", "Gibraltar", "Greece", "Vatican City", "Hungary", "Iceland", "Ireland", "Italy", "Latvia", "Liechtenstein", "Lithuania", "Luxembourg", "North Macedonia", "Malta", "Moldova", "Monaco", "Netherlands", "Northern Ireland", "Norway", "Poland", "Portugal", "Romania", "Russian Federation", "San Marino", "Scotland", "Slovakia", "Slovenia", "Spain", "Svalbard and Jan Mayen", "Sweden", "Switzerland", "Ukraine", "United Kingdom", "Wales", "Yugoslavia"],
  "Africa": [
    "Cape Verde", "Eswatini", "Cote d'Ivoire", "Eswatini", "Gambia, The", "Libya", "The Gambia", 
    "Algeria", "Angola", "Benin", "Botswana", "British Indian Ocean Territory", "Burkina Faso", "Burundi", "Cameroon", "Cabo Verde", "Central African Republic", "Chad", "Comoros", "Republic of the Congo", "Djibouti", "Egypt", "Equatorial Guinea", "Eritrea", "Ethiopia", "Gabon", "Gambia", "Ghana", "Guinea", "Guinea-Bissau", "Ivory Coast", "Kenya", "Lesotho", "Liberia", "Libyan Arab Jamahiriya", "Madagascar", "Malawi", "Mali", "Mauritania", "Mauritius", "Mayotte", "Morocco", "Mozambique", "Namibia", "Niger", "Nigeria", "Reunion", "Rwanda", "Saint Helena", "Sao Tome and Principe", "Senegal", "Seychelles", "Sierra Leone", "Somalia", "South Africa", "South Sudan", "Sudan", "Swaziland", "Tanzania", "Democratic Republic of the Congo", "Togo", "Tunisia", "Uganda", "Western Sahara", "Zambia", "Zimbabwe"],
	"Oceania": [
    "Fiji", "Timor-Leste",
